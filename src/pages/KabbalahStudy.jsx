              ...
              >
                <Card className="card-modern border-white/60 premium-shadow hover:premium-shadow-xl transition-all duration-500 group h-full rounded-[2.5rem] overflow-hidden">
                  <CardContent className="p-10 space-y-6">
                    ...
                    <Button className={`w-full bg-gradient-to-r ${cat.color} text-white font-bold py-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 btn-premium group`}>
